...
import com.store.order.service.interfaces.GenericServiceInterface;
...
public abstract class GenericController<T> {
    ...
    private final GenericServiceInterface<T> service;
    ...
    public ResponseEntity<T> get(@PathVariable Long id, String noSuchElementException){
        T item = (T) service.get(id, noSuchElementException);
